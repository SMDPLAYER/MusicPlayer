...
class ControllerFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        requireActivity().findViewById<ImageView>(R.id.btnPlay)
        requireActivity().findViewById<ImageView>(R.id.btnPlay).setOnClickListener {
        ...
        requireActivity().findViewById<ImageView>(R.id.btnNext).setOnClickListener {
            mController.transportControls.skipToNext()
        }
        requireActivity().findViewById<ImageView>(R.id.btnPrevious).setOnClickListener {
            mController.transportControls.skipToPrevious()
        }
        requireActivity().findViewById<AppCompatSeekBar>(R.id.seekBar).setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener {
    ...
    override fun onAttach(context: Context) {
        ...
        if (mMediaBrowser.isConnected) {
            mController = MediaControllerCompat.getMediaController(requireActivity())
    ...
    private val controllerCallback = object : MediaControllerCompat.Callback() {
        ...
        override fun onMetadataChanged(metadata: MediaMetadataCompat?) {
            ...
            requireActivity().findViewById<AppCompatSeekBar>(R.id.seekBar).max = (metadata?.getLong(MediaMetadataCompat.METADATA_KEY_DURATION)?.toInt()) ?: 2
        }
    }
    ...
    private fun setPlayState(state: Boolean) {
        ...
        if (state) {
            requireActivity().findViewById<ImageView>(R.id.btnPlay).setImageDrawable(context?.getDrawable(android.R.drawable.ic_media_play))

        } else {
            requireActivity().findViewById<ImageView>(R.id.btnPlay).setImageDrawable(context?.getDrawable(android.R.drawable.ic_media_pause))
        }
    }
    ...
    private fun updateProgress() {
        mLastPlaybackState?.let {
            ...
            requireActivity().findViewById<AppCompatSeekBar>(R.id.seekBar).progress = currentPos
        }
    }
